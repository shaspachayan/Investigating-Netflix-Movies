...
netflix_movies_col_subset = netflix_df_movies_only[columns]
...
for index, color in netflix_movies_col_subset.iterrows() :
    if color["genre"] == "Children" : 
        colors.append("red")
    elif color["genre"] == "Documentaries" : 
        colors.append("blue")
    elif color["genre"] == "Stand-Up" : 
        colors.append("green")
    else:
        colors.append("black")
...
are_movies_getting_shorter = "kind of"
